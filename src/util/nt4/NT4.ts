...
const typestrIdxLookup: { [String in TypeString]: number } = {
  boolean: 0,
  double: 1,
  int: 2,
  float: 3,
...
export type TypeString = "boolean" | "double" | "int" | "float" | "string" | "json" |
...
export class NT4_Client {
  ...
  publishTopic(topic: string, type: TypeString) {
