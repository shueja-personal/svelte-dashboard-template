<script lang="ts">
    ...
    let controller1 = NT.BooleanSubscriber(true, "/DriverDisplay/controller1");
    let controller2 = NT.BooleanSubscriber(true, "/DriverDisplay/controller2");

    let robotPose = NT.DoubleArraySubscriber([0,0,0], "/DriverDisplay/field/Robot")
    let targetPose = NT.DoubleArraySubscriber([0,0,0], "/DriverDisplay/field/target")
    let isBlue = NT.BooleanSubscriber(false, "/DriverDisplay/alliance")
